...
describe('CORS Configuration', () => {
  ...
  describe('Default Configuration', () => {
    it('should use default values when no environment variables are set', () => {
      ...
      expect(freshConfig.methods).toEqual(['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS']);
      expect(freshConfig.allowedHeaders).toEqual(['Content-Type', 'Authorization']);
  ...
  describe('Environment Variable Overrides', () => {
    it('should parse CORS_ORIGIN from comma-separated string', () => {
      ...
      expect(freshConfig.origin).toEqual(['https://example.com', 'https://app.example.com']);
    });
    ...
    it('should parse CORS_ALLOWED_HEADERS from comma-separated string', () => {
      ...
      expect(freshConfig.allowedHeaders).toEqual(['Content-Type', 'Authorization', 'X-Requested-With']);
    });
