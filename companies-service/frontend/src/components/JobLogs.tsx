...
import { Card, Typography, Space, Button, List, message, Spin } from 'antd';
      ...
      <Card>
        ...
        {logs.length === 0 ? (
          ...
          <List
            ...
            renderItem={(log) => (
              <List.Item>
                <div style={{ width: '100%', padding: '16px', border: '1px solid #f0f0f0', borderRadius: '8px', marginBottom: '8px' }}>
