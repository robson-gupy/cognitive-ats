"""
Modelos para mensagens de fila (SQS/Redis)
"""
...
@dataclass
class QueueMessage:
    """Mensagem genérica de fila, compatível com SQS e Redis Streams"""
    message_id: str
    ack_token: str
    body: str
    ...
    def receive_count(self) -> int:
        ...
        - SQS: usa ApproximateReceiveCount
    ...
    def sent_timestamp(self) -> Optional[datetime]:
        """Timestamp de envio quando disponível (SQS)."""
